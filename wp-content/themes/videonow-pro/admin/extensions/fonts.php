...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'videonow-pro' ) ) ) );
	$standard_fonts = customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'videonow-pro' ) ) ) );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'videonow-pro' ),
		'cyrillic'     => __( 'Cyrillic', 'videonow-pro' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'videonow-pro' ),
		'devanagari'   => __( 'Devanagari', 'videonow-pro' ),
		'greek'        => __( 'Greek', 'videonow-pro' ),
		'greek-ext'    => __( 'Greek Extended', 'videonow-pro' ),
		'khmer'        => __( 'Khmer', 'videonow-pro' ),
		'latin'        => __( 'Latin', 'videonow-pro' ),
		'latin-ext'    => __( 'Latin Extended', 'videonow-pro' ),
		'vietnamese'   => __( 'Vietnamese', 'videonow-pro' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'videonow-pro' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'videonow-pro' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'videonow-pro' ),
