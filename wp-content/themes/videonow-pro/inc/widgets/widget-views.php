 ...
 * @since      1.0.0
 */
class videonow_pro_Views_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname'   => 'widget-videonow_pro-views widget_posts_thumbnail',
			'description' => __( 'Display the most viewed posts with thumbnails.', 'videonow-pro' )
		);

		// Create the widget.
		parent::__construct(
			'videonow_pro-views',                                        // $this->id_base
			__( '&raquo; Most Viewed Posts', 'videonow-pro' ), // $this->name
	...
	function form( $instance ) {
		...
		// Default value.
		$defaults = array(
			'title'     => esc_html__( 'Most Viewed Posts', 'videonow-pro' ),
			'limit'     => 5,
			'show_views' => true
		);
