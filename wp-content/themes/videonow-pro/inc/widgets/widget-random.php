 ...
 * @since      1.0.0
 */
class videonow_pro_Random_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname'   => 'widget-videonow_pro-random widget_posts_thumbnail',
			'description' => __( 'Display random posts with thumbnails.', 'videonow-pro' )
		);

		// Create the widget.
		parent::__construct(
			'videonow_pro-random',                                   // $this->id_base
			__( '&raquo; Random Posts', 'videonow-pro' ), // $this->name
	...
	function form( $instance ) {
		...
		// Default value.
		$defaults = array(
			'title'     => esc_html__( 'Random Posts', 'videonow-pro' ),
			'limit'     => 5,
			'show_views' => true
		);
